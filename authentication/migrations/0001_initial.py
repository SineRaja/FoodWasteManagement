    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=255, unique=True, validators=[authentication.validations.validate_email], verbose_name='email address')),
                ...
                ('phone_number', models.CharField(max_length=10, validators=[authentication.validations.validate_phone])),
